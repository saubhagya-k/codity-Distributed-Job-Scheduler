...
# This table stores global retry policy templates – no ORM relationships needed.
class RetryPolicy(Base):
    ...
    base_delay = Column(Integer, nullable=False)
...
class JobLog(Base):
    ...
    # Use backref so Job automatically gets a "logs" attribute.
...
class WorkerHeartbeat(Base):
    ...
    current_job_ids = Column(JSON, default=[])
...
class DeadLetterQueue(Base):
    ...
    retry_history = Column(JSON, default=[])
